import type { PageResult } from "@white-rabbit/business-logic/src/shared/abstract-repository";
import type { Journal } from "@white-rabbit/components/src/api/JournalViewApi";
import { v4 } from "uuid";
