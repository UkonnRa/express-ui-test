    ...
    <div class="flex-1 flex flex-col gap-2">
      ...
      >
        ...
        >
          <v-card-item>
            <v-card-title
              class="mb-2 text-primary hover:underline hover:cursor-pointer"
              @click="onDetailModalClicked(group)"
            >
              {{ group.name }}
            </v-card-title>
          </v-card-item>
...
const onDeleteClicked = (entity: GroupModel) => {
  selected.value = entity;
...
const onDetailModalClicked = (entity: GroupModel) => {
  selected.value = entity;
  showDetailModal.value = true;
};
const onDetailModalClosed = async () => {
