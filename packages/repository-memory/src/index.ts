...
import { FinRecord, FinRecordRepository } from '@white-rabbit/business-logic/src/domains/fin-record';
import { Group, GroupQuery, GroupRepository, GroupValue } from '@white-rabbit/business-logic/src/domains/group';
